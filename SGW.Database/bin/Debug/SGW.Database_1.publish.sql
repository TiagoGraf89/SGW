...
GO
:setvar DatabaseName "SGW"
:setvar DefaultFilePrefix "SGW"
...
GO
PRINT N'Altering [dbo].[SGW_Workgroup]...';


GO
ALTER TABLE [dbo].[SGW_Workgroup] ALTER COLUMN [Path] VARCHAR (MAX) NULL;
